...
public sealed class PauseState : IGameState
{
    ...
    private string _message = "잠시 멈췄습니다. 저장하거나 타이틀로 돌아갈 수 있습니다.";
    ...
    public void Update(GameTime gameTime, GameContext context)
    {
        ...
        if (context.Input.WasPressed(Keys.Up) || context.Input.WasPressed(Keys.W)) _selected = (_selected + _options.Length - 1) % _options.Length;
        if (context.Input.WasPressed(Keys.Down) || context.Input.WasPressed(Keys.S)) _selected = (_selected + 1) % _options.Length;
